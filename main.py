...
'''
    ...
    '''
        ...
        ### 8. Proses Pembuatan Backtest & Terima Kasih 
        Sebenarnya, backtesting seperti ini sudah pernah dilakukan di luar negeri, tepatnya di Amerika Serikat, oleh Option Alpha, sebuah situs edukasi yang berfokus pada trading options, namun juga membahas analisis teknikal juga. Meskipun demikian, hasil backtest pada saham-saham Amerika tentu berbeda dengan kondisi pasar saham di Indonesia. Oleh karena itu, saya terinspirasi untuk membuat backtest indikator teknikal khusus untuk saham-saham Indonesia, agar hasilnya lebih relevan dan bermanfaat bagi para trader di Indonesia.
